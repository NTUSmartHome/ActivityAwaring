...
public class SwingMotionFeatureExtration {
    ...
    // Offline
    public SwingMotionFeatureExtration(String filePath, String inFilename, String outFilename, boolean withSM, boolean withG) {
    ...
    public void printFeature() {
        try {
            ...
            FileWriter fw = new FileWriter(Path + "/Features/" + OutFileName, true);
            F.initialize();
            getAccelFeatures(SM);
            getOrientationFeatures();
